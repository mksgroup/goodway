package mksgroup.goodway.user.resources;

import mksgroup.goodway.user.domain.model.entity.Entity;
import mksgroup.goodway.user.domain.model.entity.User;
import mksgroup.goodway.user.domain.service.UserService;
import mksgroup.goodway.user.domain.valueobject.UserVO;
...
public class UserController {
     ...
     * <code>http://.../user/rest</code> will find any users with upper or lower case 'rest' in their name.
     * @param name
